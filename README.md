...
<details>
<summary>1. Жизненный цикл продукта</summary>
...
<details>
<summary>2. Бизнес модели</summary>
...
<details>
<summary>3. Работа с гипотезами и продуктовые исследования</summary>
...
<details>
<summary>4. Юнит-экономика</summary>
...
<details>
<summary>5. Создание MVP продукта</summary>
...
- [Сборка приложения на зерокоде](#сборка-приложения-на-зерокоде).

</details>

<details>
<summary>6. Маркетинг</summary>
 
- [Разработка стратегии маркетинга с учетом различий поколений](#разработка-стратегии-маркетинга-с-учетом-различий-поколений)  
- [Заполнение рекламного объявления и создание email-рассылок для совершения пользователем определенных целевых действий](#заполнение-рекламного-объявления-и-создание-email-рассылок-для-совершения-пользователем-определенных-целевых-действий)  
- [Подбор ключевых фраз для SEO, выбор соц. сетей и создание контент-плана](#подбор-ключевых-фраз-для-seo-выбор-соц-сетей-и-создание-контент-плана)  
- [Описание ToV продукта и разработка краткосрочной стратегии](#описание-tov-продукта-и-разработка-краткосрочной-стратегии)  
- [Выбор и обоснование outbound и inbound каналов продвижения продукта](#выбор-и-обоснование-outbound-и-inbound-каналов-продвижения-продукта)  
- [Выбор и обоснование вариантов нестандартного маркетинга](#выбор-и-обоснование-вариантов-нестандартного-маркетинга)  

</details>

<details>
<summary>7. Soft skills для управления командной и публичных выступлений.</summary>

- [Организация процесса разработки по итеративной модели](#организация-процесса-разработки-по-итеративной-модели)
- [Подготовка конструктивных и деструктивных вопросов](подготовка-конструктивных-и-деструктивных-вопросов)

</details>

<details>
<summary>8. Особенности этапов discovery и delivery.</summary>

- [Аналитика по продуктовым решениям  приложения для автоматизации выделения участков промысла водных ресурсов](#аналитика-по-продуктовым-решениям-приложения-для-автоматизации-выделения-участков-промысла-водных-ресурсов).
- [Формирование продукта через боли ценности интересантов и конкурентов](#формирование-продукта-через-боли-ценности-интересантов-и-конкурентов).
- [Формирование ICP исследование рынка и юнитэкономика для b2b продукта](#формирование-icp-исследование-рынка-и-юнитэкономика-для-b2b-продукта).
- [Формирование ценностного предложения и проработка one pager для b2b продукта](#формирование-ценностного-предложения-и-проработка-one-pager-для-b2b-продукта).
- [Описание стратегии по оптимизации продукта и достижению измеримых результатов](#описание-стратегии-по-оптимизации-продукта-и-достижению-измеримых-результатов)
- [Формирование задач и их решение в процессах RUN и CHANGE](#формирование-задач-и-их-решение-в-процессах-run-и-change).
- [Формирование HADI-цикла для проверки гипотезы по увеличению выбранной метрики](#формирование-hadi-цикла-для-проверки-гипотезы-по-увеличению-выбранной-метрики)
...
Мой вариант выбора основных метрик [здесь](https://docs.google.com/spreadsheets/d/14fKIw8jMUiG35U-bZf1_qcrFdKxnPereFgyRkWQI958/edit?gid=0#gid=0).
...
Мой вариант CJM продукта - [таблица](https://docs.google.com/spreadsheets/d/1ossVgUagVORhcjfd_OMdieCvnExHAKTe8Qxru9yklHw/edit?usp=sharing).
...
Мой вариант стратегии - [таблица](https://docs.google.com/spreadsheets/d/14UtTdizVL_LsU8zJZSY2tO-WD_DU-u5AUi9h54u7X9A/edit?usp=sharing).
...
3. **Согласованность коммуникации**:
...
Правильные вопросы играют ключевую роль в обучении и развитии. Они помогают углубить понимание темы, стимулируют критическое мышление и способствуют активному вовлечению участников в процесс. Конструктивные вопросы направляют на поиск решений и развитие идей, в то время как деструктивные могут выявить недостатки и области для улучшения.
